...
enum layer_number {
    BASE = 0,
    NUMBERS, SYMBOLS, FUNCTIONS,
    LOWER, UPPER, UTIL,
    MOUSE, BALL_SETTINGS, LIGHT_SETTINGS
};
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [BASE] = LAYOUT(
        ...
        KC_TAB,       LWIN_T(KC_A),  LALT_T(KC_S),  LSFT_T(KC_D),  LCTL_T(KC_F),            LT(NUMBERS, KC_G),
    ...
    [NUMBERS] = LAYOUT(
        ...
        // 右手
        _______, _______, _______, _______, _______, _______,
        _______, LSFT(KC_SEMICOLON), KC_MINUS,                 LSFT(KC_LEFT_BRACKET), LSFT(KC_RIGHT_BRACKET), _______,
        _______, LSFT(KC_COLON),     KC_SLASH,                 LSFT(KC_8),            LSFT(KC_9),             _______,
        _______, LSFT(KC_6),         LSFT(KC_NONUS_BACKSLASH), KC_LEFT_BRACKET,       KC_RIGHT_BRACKET,
                                   _______,
        _______, _______,
        _______, _______, _______, _______,          _______,
        _______, _______,                            _______
